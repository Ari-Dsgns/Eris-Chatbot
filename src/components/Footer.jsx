...
export const Footer = ({ onHomeClick, onHelpClick }) => {
    return (
        <footer className='flex justify-evenly items-center mt-2 p-4 rounded-2xl shadow-normal '>
            <button className='flex flex-col items-center cursor-pointer text-buttons hover:text-pink-800 bg-transparent border-none outline-none focus:outline-none focus:ring-2 focus:ring-pink-500'
                onClick={onHomeClick}
